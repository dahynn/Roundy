...
public enum Stage {
    ...
    /**
     * 자기소개 - 한 명씩 발언권을 가지고 소개 (60초/인)
     */
    SELF_INTRO(60, 1),
    
    /**
     * 첫인상 투표 - 첫 느낌으로 마음에 드는 사람 선택 (30초)
     */
    VOTE_FIRST(30, 2),
    
    /**
     * 짧은 1:1 대화 - 3분간 랜덤 페어링 대화 (180초)
     */
    ROTATION_SHORT(180, 3),
    
    /**
     * 이미지 게임 - 아이스브레이킹 게임 (120초)
     */
    IMAGE_GAME(120, 4),
    
    /**
     * 긴 1:1 대화 - 7분간 랜덤 페어링 대화 (420초)
     */
    ROTATION_LONG(420, 5),
    
    /**
     * 최종 투표 - 대화 후 최종 선택 (30초)
     */
    VOTE_FINAL(30, 6),
    
    /**
     * 매칭 결과 발표 - 쌍방 매칭 확인 및 결과 공개 (60초)
     */
    MATCHING_RESULT(60, 7),
    
    /**
     * 얼굴 공개 - 매칭 성공 시 얼굴 공개 단계 (300초)
     */
    FACE_REVEAL(300, 8);
