...
public class VerificationController {
        ...
        public ResponseEntity<CommonResponse<?>> verify(
                ...
                try {
                        ...
                        com.ssafya701.roundy.global.infra.ai.AiVerificationResult result = aiServerClient
                                        .verifyFace(realtimeImage, originalImage);
                        ...
                        // 8. 응답
                        com.ssafya701.roundy.verification.dto.response.VerificationResponse response = new com.ssafya701.roundy.verification.dto.response.VerificationResponse(
        ...
        public ResponseEntity<CommonResponse<com.ssafya701.roundy.verification.dto.response.VerificationImageResponse>> getVerificationPhoto(
                ...
                return ResponseEntity.ok(CommonResponse.ofSuccess(
                                new com.ssafya701.roundy.verification.dto.response.VerificationImageResponse(
                                                verificationImgUrl)));
        }
}
