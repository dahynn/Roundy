...
interface Step5_FinalVoteProps {
...
export const Step5_FinalVote: React.FC<Step5_FinalVoteProps> = ({
    participants,
    currentUserGender,
    selectedCard,
    onSelect,
        ...
        <div className="w-full h-full flex flex-col items-center justify-center gap-10 px-6 animate-in fade-in duration-700">
            ...
            <div className="text-center space-y-2 relative z-10">
                <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight">
                    최종 <span className="text-[#FF4D94]">선택</span>의 시간
                </h2>
                <p className="text-white/50 text-sm">
                    가장 마음이 끌렸던 한 사람을 선택해주세요
                </p>
            </div>
